    ...
    const response = await fetch('https://ai.gateway.lovable.dev/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { 
            role: 'system', 
            content: `You are Ryan Waweru's portfolio assistant. You help visitors learn about Ryan's skills, experience, and projects. 
            
            Key information about Ryan:
            - Senior Software Engineer specializing in full-stack development
            - Expert in React, TypeScript, Node.js, Python, and AI integration
